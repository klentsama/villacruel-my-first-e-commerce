  ...
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
      ...
      @foreach($brand as $brands)
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brands->id }}">
        <a href="/products?selected_brands[0]={{ $brands->id }}" class="">
          <img src="{{ url('storage', $brands->image) }}" alt="{{ $brands->name }}" class="object-cover w-full h-64 rounded-t-lg">
        </a>
